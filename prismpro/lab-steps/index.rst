...
.. |WEBSERVER| replace:: http://10.45.32.157/
.. |br| raw:: html
...
#. You can name it whatever you would like. A suggestion would be to name it your name. For the examples we give we will use 'PrismProVM'.
...
#. Right click the following URL to open a new tab and navigate to the webpage at |WEBSERVER| and enter the details in the Setup portion of the form. Then click 'Begin Setup' once you have filled in all the fields. This will get your environment ready for this lab. **Keep this tab open during entire Prism Pro lab to return to as directed in later portions.**
...
#. Start by hitting the refresh button in your browser to reload the Prism Central Page.
...
#. **Switch tabs back to** the |WEBSERVER| page and continue to the Story 1-3 Step.
...
#. **Switch back to the other tab** running |WEBSERVER| and Simulate the ‘VM Bully Detected’ alert for Story 5.
